...
export PATH="$BASE_DIR"/output/:$PATH
export TORCH_PATH=%TORCH_PATH%
export LD_LIBRARY_PATH="$BASE_DIR"/output/:"$BASE_DIR":"$TORCH_PATH":$LD_LIBRARY_PATH
export QML_IMPORT_PATH="$BASE_DIR"/output/:$QML_IMPORT_PATH
export QML2_IMPORT_PATH="$BASE_DIR"/output/:$QML2_IMPORT_PATH
export QT_PLUGIN_PATH="$BASE_DIR"/output/:$QT_PLUGIN_PATH
export QTWEBENGINEPROCESS_PATH="$BASE_DIR"/output//QtWebEngineProcess
export QTDIR="$BASE_DIR"
export CQT_PKG_ROOT="$BASE_DIR"
export CQT_RUN_FILE="$BASE_DIR/Perticon.sh"

export QT_QPA_PLATFORM_PLUGIN_PATH="$BASE_DIR"/output//platforms:$QT_QPA_PLATFORM_PLUGIN_PATH



"$BASE_DIR/output/Perticon" "$@" 
